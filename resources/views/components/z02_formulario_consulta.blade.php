...
<form class="row col-md-12"  action="{{ route('consulta.buscar') }}" method="GET">
            @csrf
                    ...
                    <div class="col-md-3 form-group">
                    <label for="nombre" style="font-size: 15px;">FECHA: (No es obligatorio llenar)</label>
                    <input type="date" class="form-control" id="fecha" name="fecha" placeholder="NO ES OBLIGATORIO LLENAR ESTE CAMPO">
                    </div>
