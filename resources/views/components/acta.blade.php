...
@csrf
                                ...
                                <div class="space-x-3 flex justify-between"> 
                                    ...
                                    <div class="flex-1 space-y-3">
                                        ...
                                        <select name="condicion_id"  id="colorSelect" onchange="changeColor()" class="bg-white-50 border border-gray-200 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-64 h-10 p-2.5 dark:focus:border-blue-500">
                                            <option type="text" value="PENTIENDE">Pentiende</option>
                                    ...
                                    <div class="flex-1 space-y-3">
                                            ...
                                            <input type="text" name="acta" id="acta_de_control"
                                                ...
                                                placeholder="Ingrese número de acta de control" autocomplete="off" required>
                                    </div>
                    ...
                    <div class="space-x-3 flex justify-between">
                        <div class="flex-1 space-y-3">
                            ...
                            <input type="text" name="dni" id="dni" value=""
                                class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese su DNI" onchange="consultarDatosDNI(this.value)" autocomplete="off" required>
                        </div>
    ...
    <div class="space-x-3 flex justify-between">  
        <div class="flex-1 space-y-3">
                ...
                class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Ingrese la licencia" autocomplete="off" required>
            </div>
    ...
    <div class="space-x-3 flex justify-between">  
            ...
            <div class="flex-1 space-y-3">
                ...
                class="bg-gray-50 border outline-none border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    placeholder="Ingrese la Placa" onchange="consultarPlaca(this.value)" autocomplete="off" required>
            </div>
