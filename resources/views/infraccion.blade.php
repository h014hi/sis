<x-guest-layout>
    ...
    <body class="container col-md-12">
        ...
        <article class="container">
            ...
            <div >
                <p class="m_p">
                    *   Si usted no esta de acuerdo con realizar el importe respectivo, puede presentar un descargo de acuerdo al <b>D.S. Nº 004-2020-MTC, Artículo 7 numeral 7.1 Efectuar los descargos de la imputación efectuada</b></p>
                <p>
                    Siempre y cuando tenga las suficientes evidencias para desvirtuar el acta de control.
                </p>
                <p class="m_p_infra">
                    **  El importe con 50% de descuento se aplica siempre y cuando este dentro del plazo de los 5 dias habiles, contando despues del dia siguiente de la intervencion(no se cuentan sabados o domingos). 
                </p>
